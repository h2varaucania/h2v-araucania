...
export default async function Gobernanza() {
  let hero = { titulo: 'Modelo de Gobernanza', subtitulo: 'Estructura de dirección, gestión y control del programa para garantizar transparencia, eficiencia y sostenibilidad.' };
