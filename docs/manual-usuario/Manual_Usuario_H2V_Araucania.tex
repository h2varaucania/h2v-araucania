...
\textbf{\color{h2vazul}Versión} & 1.0 \\[3pt]
\textbf{\color{h2vazul}Fecha} & 21 de agosto de 2026 \\[3pt]
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.354\textwidth}>{\raggedright\arraybackslash}p{0.576\textwidth}}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.327\textwidth}>{\raggedright\arraybackslash}p{0.190\textwidth}>{\raggedright\arraybackslash}p{0.413\textwidth}}
...
\rowcolor{filaalt}Imagen dentro del texto de una noticia & JPG o PNG & 1200 píxeles de ancho máximo \\ \bottomrule
\end{longtable}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.202\textwidth}>{\raggedright\arraybackslash}p{0.375\textwidth}>{\raggedright\arraybackslash}p{0.353\textwidth}}
...
Respaldo & La base de datos Neon mantiene respaldos y historial; el contenido también queda versionado en el panel (noticias y eventos). & Consola de Neon. \\ \midrule
\rowcolor{filaalt}Accesos a las cuentas de servicio & Vercel, Neon, Resend, GitHub y el registrador del dominio. & Deben traspasarse formalmente a la SEREMI (o a quien esta designe) en el acta de traspaso, con cambio de contraseñas. \\ \bottomrule
\end{longtable}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.108\textwidth}>{\raggedright\arraybackslash}p{0.104\textwidth}>{\raggedright\arraybackslash}p{0.449\textwidth}>{\raggedright\arraybackslash}p{0.270\textwidth}}
\rowcolor{h2vazul}\textbf{\color{white}Versión} & \textbf{\color{white}Fecha} & \textbf{\color{white}Cambios} & \textbf{\color{white}Autor} \\
\endfirsthead
\rowcolor{h2vazul}\textbf{\color{white}Versión} & \textbf{\color{white}Fecha} & \textbf{\color{white}Cambios} & \textbf{\color{white}Autor} \\
\endhead
1.0 & 21 de agosto de 2026 & Primera versión completa, con capturas del panel en producción (versión del sitio de agosto de 2026). & Equipo del Bien Público H2V Araucanía (Universidad de Talca) \\ \bottomrule
\end{longtable}
\end{document}