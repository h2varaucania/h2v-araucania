...
\textbf{\color{h2vazul}Fecha} & 23 de septiembre de 2026 \\[3pt]
...
\rowcolor{filaalt}\textbf{Editor (puede publicar contenido)} & Crear y editar noticias, documentos, eventos, proyectos, miembros, capas KMZ y los textos de las Páginas. \textbf{No} puede eliminar, \textbf{no} ve Usuarios y \textbf{no} puede cambiar la Configuración. & Quien publica contenido con frecuencia. \\ \midrule
...
\begin{enumerate}
  ...
  \item Complete \textbf{Correo electrónico} (1); en \textbf{Nueva Contraseña} (2) y \textbf{Confirmar Contraseña} (3) ponga una contraseña provisional cualquiera, que nadie necesita conocer; luego \textbf{Nombre completo} (4) y, en la barra lateral, el \textbf{Rol} (5). \textbf{Institución} es opcional.
  \item Pulse \textbf{Guardar} (6).
  \item \textbf{No le comunique la contraseña.} Pídale que, en la pantalla de entrada, use \textbf{¿Olvidaste tu contraseña?} con su correo: recibirá un enlace para crear la suya. Así solo ella la conoce.
\end{enumerate}
\begin{figure}[H]\centering
...
\begin{enumerate}
  \item El Administrador crea un usuario para cada persona, con rol \textbf{Editor} (vea ''Crear un usuario''). Como contraseña pone una provisional que nadie necesita conocer.
  \item Cada persona crea su propia contraseña: en la pantalla de entrada del panel, \textbf{¿Olvidaste tu contraseña?} $\rightarrow$ escribe su correo $\rightarrow$ abre el mensaje que recibe $\rightarrow$ define su contraseña.
  \item Cada persona entra al panel y comprueba que ve el Panel de Control.
  \item Práctica guiada con este manual: cada persona crea una noticia de prueba, la publica y la ve en el sitio. Después un Administrador la elimina (un Editor no puede eliminar contenido, y eso es a propósito).
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.340\textwidth}>{\raggedright\arraybackslash}p{0.590\textwidth}}
...
Cambiar textos del pie de página & Configuración $\rightarrow$ Configuración General \\ \midrule
\rowcolor{filaalt}Cambiar el nombre del sitio (pestaña del navegador) & Configuración $\rightarrow$ Configuración General $\rightarrow$ Nombre del sitio \\ \midrule
Editar la Hoja de Ruta & Páginas $\rightarrow$ Hoja de Ruta $\rightarrow$ Hitos del timeline \\ \midrule
\rowcolor{filaalt}Editar el contenido educativo de H2V & Páginas $\rightarrow$ Hidrógeno Verde \\ \midrule
Crear una cuenta para un colega & Cuentas y acceso $\rightarrow$ Usuarios $\rightarrow$ Crear nuevo \\ \midrule
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.202\textwidth}>{\raggedright\arraybackslash}p{0.376\textwidth}>{\raggedright\arraybackslash}p{0.352\textwidth}}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.143\textwidth}>{\raggedright\arraybackslash}p{0.474\textwidth}>{\raggedright\arraybackslash}p{0.313\textwidth}}
...
23 de septiembre de 2026 & Sección de archivos KMZ reescrita paso a paso (Google Earth en el navegador, mensajes de error, cambiar o quitar una forma). Nuevo capítulo ''Traspaso del sitio a la SEREMI''. Usuarios: cada persona crea su propia contraseña. Figuras de noticia y evento actualizadas. & Equipo del Bien Público H2V Araucanía (Universidad de Talca) \\ \bottomrule
\end{longtable}
\end{document}