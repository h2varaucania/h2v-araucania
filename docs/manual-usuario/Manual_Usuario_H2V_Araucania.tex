...
\rowcolor{filaalt}\textbf{Fase 2: la infraestructura} & Las cuentas de fondo (el correo central, el alojamiento en Vercel, la base de datos en Neon, el código en GitHub y el envío de correos en Resend), junto con la \textbf{Guía técnica} del sitio. & Un responsable técnico designado por la SEREMI. & Meta: enero de 2027. \\ \bottomrule
\end{longtable}
Los pasos de cada fase, con casillas para marcar y las hojas para firmar (la constancia de la Fase 1 y el acta final de la Fase 2), están en el \textbf{Protocolo de entrega del sitio web H2V Araucanía}. Ese documento se usa en las reuniones; este capítulo resume lo que conviene saber después.

\begin{recuadro}{cSeguridad}{bSeguridad}\textbf{\color{bSeguridad}Seguridad:} regla de oro. Ninguna contraseña se dicta, se anota en un papel compartido ni se envía por correo o por mensajería. \textbf{Cada persona escribe la suya}, en el momento.\end{recuadro}
\section{Después del traspaso: quién hace qué}
\begin{longtable}{>{\raggedright\arraybackslash}p{0.415\textwidth}>{\raggedright\arraybackslash}p{0.202\textwidth}>{\raggedright\arraybackslash}p{0.313\textwidth}}
\rowcolor{h2vazul}\textbf{\color{white}Tarea} & \textbf{\color{white}Quién} & \textbf{\color{white}Dónde se explica} \\
\endfirsthead
\rowcolor{h2vazul}\textbf{\color{white}Tarea} & \textbf{\color{white}Quién} & \textbf{\color{white}Dónde se explica} \\
\endhead
Publicar noticias, eventos, documentos y proyectos, y editar las páginas & Editores y Administradores & “Tareas frecuentes, paso a paso” y “Editar los textos de cada página” \\ \midrule
\rowcolor{filaalt}Leer y responder los mensajes del formulario de Contacto & Editores y Administradores & “Leer los mensajes del formulario de Contacto” \\ \midrule
Crear cuentas, cambiar roles y reponer contraseñas & Administradores & “Usuarios, roles y seguridad” \\ \midrule
\rowcolor{filaalt}Revisar que el respaldo diario funcione y guardar una copia mensual & Responsable técnico & Guía técnica, “Respaldos” \\ \midrule
Actualizar el software del sitio & Responsable técnico & Guía técnica, “Mantención y seguridad” \\ \midrule
\rowcolor{filaalt}Contratar el dominio y decidir el alojamiento definitivo & La SEREMI, con su responsable técnico & Guía técnica, “Dirección propia” \\ \bottomrule
\end{longtable}
\section{Si una persona deja la institución}
\begin{enumerate}
  \item Ese mismo día, un Administrador elimina su cuenta del panel o le cambia el rol (vea “Usuarios, roles y seguridad”).
  \item Si era Administrador, compruebe que siguen quedando \textbf{dos} Administradores.
  \item Si tenía acceso a la cuenta central de Google o a GitHub, el responsable técnico cambia la contraseña y reemplaza su teléfono en la verificación en dos pasos (Guía técnica, “Mantención y seguridad”).
\end{enumerate}
\section{Dónde están los respaldos}
\begin{itemize}
  \item \textbf{Noticias y eventos:} cada publicación guarda una versión, que se recupera desde la pestaña \textbf{Versiones} (vea “Borrador, publicado y versiones”).
  \item \textbf{Todo el contenido del panel:} la base de datos se copia sola todos los días y cada copia se guarda 90 días. Si se borró algo por error, el responsable técnico puede recuperarlo.
  \item \textbf{Fotos, PDF y capas KMZ:} el responsable técnico guarda una copia una vez al mes.
\end{itemize}
\begin{recuadro}{cResultado}{bResultado}\textbf{\color{bResultado}Resultado:} desde la Fase 1 la SEREMI publica con sus propios usuarios; desde el acta final de la Fase 2 queda a cargo de todo el sitio.\end{recuadro}
...
Esta ficha resume lo esencial para el equipo informático de la SEREMI. El detalle completo (cuentas, variables, respaldos, dominio, actualizaciones y cómo llevar el sitio a otro servidor) está en la \textbf{Guía técnica del sitio web H2V Araucanía}, que se entrega al responsable técnico; en el repositorio, en \texttt{docs/tecnico/}.
